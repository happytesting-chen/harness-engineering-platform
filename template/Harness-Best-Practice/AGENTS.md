...
This file is the authoritative workflow for the coding assistant working on this project.

The developer should be able to open the copied project with a coding assistant, ask it to read this file, describe the product in the chat, and then follow the guided workflow below.
...
├── Harness-Best-Practice/            ← Workflow state + this file
