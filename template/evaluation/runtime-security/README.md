...
This directory ships **empty** in new projects. Content is generated by running
`python3 evaluation/eval.py` after phase sign-off.

Historical harness-development evidence (classifier benchmarks, attack traces, verdict
files) lives in `docs/harness-development/evaluation-runtime-security/` — it is NOT
copied into product projects.
